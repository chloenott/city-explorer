  ...
  render() {
    return (
      <Card style={{ maxWidth: '18rem' }}>
        <Card.Img src={`https://maps.locationiq.com/v3/staticmap?key=${process.env.REACT_APP_LOCATION_API_KEY}&center=${this.props.data.lat},${this.props.data.lon}&zoom=${10}`} fluid />
        <Card.Body>
