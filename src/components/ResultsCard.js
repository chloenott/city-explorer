...
export default class ResultsCard extends React.Component {
  render() {
    return (
      <Card style={{ maxWidth: '18rem' }} onClick={() => this.props.updateUserSelection(this.props.data)}>
        ...
        <Card.Body>
          ...
          <Card.Text onClick={() => this.props.updateUserSelection(this.props.data)} style={{ color: 'blue' }}>Click for Weather</Card.Text>
        </Card.Body>
      </Card>
    );
  }
